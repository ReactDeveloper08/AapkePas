...
/**
 * Custom Bitmap cache config for Fresco based off of
 * {@link DefaultBitmapMemoryCacheParamsSupplier}
 */
public class CustomBitmapMemoryCacheParamsSupplier implements Supplier<MemoryCacheParams> {
    ...
    private int getMaxCacheSize() {
        ...
        if (maxMemory < 32 * ByteConstants.MB) {
            ...
            // We don't want to use more ashmem on Gingerbread for now, since it doesn't
            // respond well to
