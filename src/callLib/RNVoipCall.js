...
//   addEventListener = async (type, handler) => {
//     const listener = await listeners[type](handler);
...
//     this.rnVoipCallEventHandlers.clear();
//   };

//   initializeCall = async options =>
...
//         RNVoipCall.displayIncomingCall({
...
//           RNVoipCall.displayIncomingCall(
//             options.callerId,
//             iosOptions.phoneNumber,
//             iosOptions.handleType,
//             iosOptions.hasVideo,
//             iosOptions.name,
//           ),
//         );
...
//     let finalData = {};
//     if (IsIOS) {
//       finalData['phoneNumber'] = object.phoneNumber
//         ? object.phoneNumber
//         : '1234567890';
//       finalData['handleType'] = object.handleType
//         ? object.handleType
//         : 'number';
...
//   getInitialNotificationActions = () =>
//     new Promise((resolve, reject) => {
//       if (!IsIOS) {
//         console.log(
//           ' you need to call the initial notification actions.',
//           resolve,
//         );
...
//   resetNotificationProvider = handler => {
//     this.addEventListener('didResetProvider', handler);
//   };
...
//   isCallActive = async uuid =>
//     IsIOS ? await RNVoipCall.isCallActive(uuid) : null;

//   endCall = uuid =>
//     IsIOS ? RNVoipCall.endCall(uuid) : RNVoipCall.clearNotificationById(uuid);

//   endAllCalls = () =>
//     IsIOS ? RNVoipCall.endAllCalls() : RNVoipCall.clearAllNotifications();
...
//   //Missed Call
//   showMissedCallNotification = (title, body, uuid) =>
//     RNVoipCall.showMissedCallNotification(title, body, uuid);
// }
...
class RNVoipCallNativeModule {
  ...
  initializeCall = async options =>
    new Promise((resolve, reject) => {
      if (!options.appName) {
        console.log(
          '🚀 ~ file: RNVoipCall.js:208 ~ RNVoipCallNativeModule ~ newPromise ~ options.appName:',
          options.appName,
        );
        reject({error: true, message: 'appName is required'});
      }
