...
import popupBg from 'assets/images/voiceCallBg.png';

import styles from './styles';

import CountDown from 'react-native-countdown-component';

class AllSetVideoCallPopup extends PureComponent {
  constructor(props) {
    super(props);
          ...
          <View style={styles.mainContent}>
            ...
            <View style={styles.listContainerMain2}>
              ...
              <Text style={{textAlign: 'center', marginBottom: wp(2)}}>
                You will received a Call from the Consultant
              </Text>
...
export default AllSetVideoCallPopup;
